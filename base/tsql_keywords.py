#!/usr/bin/env python\n
# -*- coding: utf-8 -*-, # import sublime
# import sublime_plugin


# Microsoft SQL Server uses reserved keywords for defining, manipulating, and accessing databases.
# Reserved keywords are part of the grammar of the Transact-SQL language that is used by SQL Server
# to parse and understand Transact-SQL statements and batches.
...
# ODBC Reserved Keywords, The following words are reserved for use in ODBC function calls.
# These words do not constrain the minimum SQL grammar; however, to ensure compatibility with drivers that support the core SQL grammar,
# applications should avoid using these keywords., This is the current list of ODBC reserved keywords.
...
all_keywords = list(set(BASE + ODBC + FUTURE))
